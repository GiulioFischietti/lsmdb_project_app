...
class CustomerAnalytics extends StatefulWidget {
  const CustomerAnalytics({Key? key});
...
class _CustomerAnalyticsState extends State<CustomerAnalytics> {
  ...
  void initState() {
    ...
    managerProvider.getCustomerAnalytics(
      ...
      return ListView(
        children: [
          ...
          Container(
            ...
            alignment: Alignment.centerLeft,
            child: Text("Customer activity rank based on number of orders",
                textScaleFactor: 1,
                textAlign: TextAlign.left,
                              ...
                              children: [
                                Expanded(
                                    flex: managerProvider
                                        .customerAnalytics[index].orderCount,
                                    child: Container(
                                      height: 20,
                                      decoration:
                                ...
                                Expanded(
                                  flex: managerProvider.totalOrders -
                                      managerProvider
                                          .customerAnalytics[index].orderCount,
                                  child: Container(
                                    height: 20,
