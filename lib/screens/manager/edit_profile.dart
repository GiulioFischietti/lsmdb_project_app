...
class _EditProfileState extends State<EditProfile> {
  ...
  void setFields() async {
    ...
    setState(() {
      name_controller.text = managerProvider.manager.name;
      username_controller.text = managerProvider.manager.username;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Consumer<ManagerProvider>(builder: (context, managerProvider, _) {
                            ...
                            Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                        child: Text(
                                      managerProvider.manager.name,
                                      style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.bold),
                                    )),
                                    Container(
                                        child: Text(
                                      "@" + managerProvider.manager.username,
                                      style: GoogleFonts.poppins(
