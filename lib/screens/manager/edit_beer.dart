...
class EditBeer extends StatefulWidget {
  Beer beer;
  EditBeer({Key? key, required this.beer}) : super(key: key);
...
class _EditBeerState extends State<EditBeer> {
  ...
  void setFields() async {
    ...
    setState(() {
      name_controller.text = widget.beer.name;
      price_controller.text = widget.beer.price.toStringAsFixed(2);
      stock_controller.text = widget.beer.stock.toString();
      short_description_controller.text = widget.beer.shortDescription;
      description_controller.text = widget.beer.description;
      alcohol_controller.text =
          widget.beer.alcoholPercentage.toStringAsFixed(1);
      volume_controller.text = widget.beer.volumeMl.toString();
    });
  }
