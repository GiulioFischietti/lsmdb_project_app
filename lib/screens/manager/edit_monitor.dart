...
class EditMonitor extends StatefulWidget {
  Monitor monitor;
  EditMonitor({Key? key, required this.monitor}) : super(key: key);

  @override
  _EditMonitorState createState() => _EditMonitorState();
}
...
class _EditMonitorState extends State<EditMonitor> {
  XFile? _image;
  ...
  void setFields() async {
    ...
    setState(() {
      name_controller.text = widget.monitor.name;
      price_controller.text = widget.monitor.price.toStringAsFixed(2);
      stock_controller.text = widget.monitor.stock.toString();
      short_description_controller.text = widget.monitor.shortDescription;
      description_controller.text = widget.monitor.description;
      special_features_controller.text = widget.monitor.specialFeatures;
      framerate_controller.text = widget.monitor.refreshRate.toString();
    });
  }
