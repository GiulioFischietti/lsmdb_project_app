...
class Event extends StatefulWidget {
  ...
  Event({this.image, this.tag, this.id, this.name});
  @override
...
class _EventState extends State<Event> {
  ...
  Future<void> getEvent() async {
    String response = await Request.get('eventbyid?_id=' + widget.id);

    setState(() {
      event = EventModel.fromJson(jsonDecode(response)['data']);
      isLoading = false;
    });
  }
                      ...
                      ? false
                          ? Row(
                              ...
                              children: [
                                  ...
                                  Container(
                                      margin:
                                          EdgeInsets.only(left: 10, top: 27.5),
                                                                            ...
                                                                            TextButton(
                                                                                onPressed: () {
                                                                                  ...
                                                                                  if (event.other_organizers[index].type.toLowerCase() == "club") {
                                                                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Club(id: event.other_organizers[index].id.toString(), image: event.other_organizers[index].image, name: event.other_organizers[index].name, slug: event.other_organizers[index].id.toString())));
                                                                                  } else if (event.other_organizers[index].type.toLowerCase() == "organizer") {
                                                                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Organizer(id: event.other_organizers[index].id, image: event.other_organizers[index].image, name: event.other_organizers[index].name)));
                                                                                  }
                                                                                },
                                                                                child: Row(
                                                                                  children: [
                                    ...
                                    text: TextSpan(children: <TextSpan>[
                                      ...
                                      TextSpan(
                                          ...
                                          style: TextStyle(
                                              ...
                                              fontWeight: FontWeight.w400)),
                                      TextSpan(
                                          text: getDay(event.end.weekday - 1) +
                                              ' ' +
                    ...
                    onPressed: () {
                      if (event.saved) {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text("Rimosso con successo"),
                        ));
                        removeEvent();
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text("Salvato con successo"),
                        ));
                        saveEvent();
                      }
                      setState(() {
