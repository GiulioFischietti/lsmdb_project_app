    ...
    return Scaffold(
        body: Container(
            ...
            child: Consumer<LanguageProvider>(
              ...
              return SafeArea(
                  child: (isLoadingLogin && (customProvider.text == null))
                      ? Center(
                          child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                              CircularProgressIndicator(),
                              customProvider.isErrorLanguageVisible
                                  ? Container(
                                      margin: EdgeInsets.all(40),
                                      child: Text(
                                          'Connection error, setting default language: en_GB',
                          ...
                          children: [
                            Container(
                                ...
                                child: TextButton(
                                    ...
                                    child: Text(
                                      customProvider.text.needfy.skip,
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 20,
                                                        ...
                                                        recognizer:
                                                            new TapGestureRecognizer()
                                                              ..onTap =
                                                                ...
                                                                print('aaaa');
                                                                if (await canLaunch(
                                                                    "https://www.needfy.it/privacy/privacy-policy.pdf")) {
                                                                  await launch(
                                                                    "https://www.needfy.it/privacy/privacy-policy.pdf",
                                                                    forceSafariVC:
                                                                        false,
                                                                  ...
                                                                  throw 'Could not launch  "https://www.needfy.it/privacy/privacy-policy.pdf"';
                                                                }
                                                              },
                                                        text: customProvider
                                                            .text
