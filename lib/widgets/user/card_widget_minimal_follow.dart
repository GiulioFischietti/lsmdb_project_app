...
class CardWidetMinimalFollow extends StatefulWidget {
  EntityMinimal entityMinimal;
  ObjectId myUserId;
  bool followable;
  CardWidetMinimalFollow(
  ...
  @override
  State<CardWidetMinimalFollow> createState() => _CardWidetMinimalFollowState();
}

class _CardWidetMinimalFollowState extends State<CardWidetMinimalFollow> {
  bool followed = false;
            ...
            InkWell(
                  ...
                  switch (widget.entityMinimal.type) {
                    case "user":
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (ctx) =>
                              UserPage(id: widget.entityMinimal.id)));
                      break;
                    case "organizer":
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (ctx) =>
                    ...
                    case "club":
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (ctx) =>
                              ClubDetails(id: widget.entityMinimal.id)));
                      break;
                    case "":
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (ctx) =>
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        child: Text(
                            widget.entityMinimal.username != ""
                                ? ("@" + widget.entityMinimal.username)
                                : widget.entityMinimal.type,
