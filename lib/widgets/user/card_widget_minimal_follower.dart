...
class CardWidetMinimalFollower extends StatefulWidget {
  UserMinimal entityMinimal;
  ObjectId myUserId;
  bool followable;
  CardWidetMinimalFollower(
  ...
  @override
  State<CardWidetMinimalFollower> createState() =>
      _CardWidetMinimalFollowerState();
}

class _CardWidetMinimalFollowerState extends State<CardWidetMinimalFollower> {
  bool followed = false;
            ...
            InkWell(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (ctx) => UserPage(id: widget.entityMinimal.id)));
                },
                child: Column(
