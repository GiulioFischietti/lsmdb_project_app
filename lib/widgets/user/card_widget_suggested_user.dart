...
import 'package:eventi_in_zona/screens/user/user_page.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:objectid/objectid.dart';

class CardWidetSuggestedUser extends StatefulWidget {
  UserMinimal userMinimal;
  ObjectId myUserId;
  bool followable;
  CardWidetSuggestedUser(
  ...
  @override
  State<CardWidetSuggestedUser> createState() => _CardWidetSuggestedUserState();
}

class _CardWidetSuggestedUserState extends State<CardWidetSuggestedUser> {
  bool followed = false;
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: NetworkImage(widget.userMinimal.image))),
            ),
            InkWell(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (ctx) => UserPage(id: widget.userMinimal.id)));
                },
                child: Column(
                  ...
                  children: [
                    Container(
                        child: Text(widget.userMinimal.name,
                            style: GoogleFonts.poppins(
                                fontWeight: FontWeight.bold))),
                    Container(
                        child: Text(widget.userMinimal.username,
                    ...
                    ? followed
                        ? InkWell(
                            onTap: () async {
                              ...
                              await unfollowUser(
                                  widget.myUserId, widget.userMinimal.id);
